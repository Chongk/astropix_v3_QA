"""
Central module of astropix. This incorporates all of the various modules from the original 'module' directory backend (now 'core'). The class methods of all the other modules/cores are inherited here. 

Author: Autumn Bauman
Maintained by: Amanda Steinhebel, amanda.l.steinhebel@nasa.gov
Modified by ckim, Feb. 9, 2026
"""
...
class astropixRun:
    ...
    def __init__(self, chipversion = 2, offline:bool=False): # ckim
        """
...
#################### ckim ####################
    ...
    # Clear SPI FIFO by read it out 1 sec
    def dump_remnants(self):
        logger.info("Clear remnants of previous run by read it out 1 second...")
